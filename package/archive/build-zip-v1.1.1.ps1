...
Write-Host "  Mode: onedir + ZIP" -ForegroundColor Cyan
Write-Host "========================================" -ForegroundColor Cyan
Write-Host ""
...
if ($LASTEXITCODE -eq 0) {
    ...
    # Create temp directory with correct structure (IRtool-v1.1.1 folder inside)
    ...
    # Create ZIP archive from temp dir - so when extracted, it creates IRtool-v1.1.1 folder
    ...
    Write-Host "Type: ZIP archive" -ForegroundColor Cyan
    Write-Host ""
    Write-Host "解压后目录结构: $outputName/" -ForegroundColor White
